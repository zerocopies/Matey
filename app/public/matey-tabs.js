...
(function () {
  ...
  function tabUrl(id) {
    return ({ 'starring': './starring.html', 'hooks': './hooks.html', 'markdown': './markdown.html', 'custom': './preview.html#custom' })[id] || '#';
  }
  ...
  function renderTabs() {
    ...
    else if (hash === '#custom') active = 'custom';
    else if (path.indexOf('preview') !== -1) active = 'custom';
    else active = 'starring';
    var labels = { 'starring': 'Starring', 'hooks': 'Hooks', 'markdown': 'Markdown', 'custom': 'Custom' };
